...
echo -e "\nGetting jailer..."
echo -e "Url: ${JAILER_LATEST_RELEASE}\n"
# jailer
[[ -e jailer ]] || wget -q --show-progress -O jailer $JAILER_LATEST_RELEASE
chmod +x jailer
sleep 1

FIRECTL_LATEST_RELEASE="https://firectl-release.s3.amazonaws.com/firectl-v0.1.0"
echo -e "\nGetting firectl..."
echo -e "Url: ${FIRECTL_LATEST_RELEASE}\n"
# firectl
[[ -e firectl ]] || wget -q --show-progress -O firectl $FIRECTL_LATEST_RELEASE
chmod +x firectl
sleep 1
